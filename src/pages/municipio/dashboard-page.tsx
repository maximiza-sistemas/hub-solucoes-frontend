                        ...
                        <div className="card-body">
                            <div className="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 className="h2 fw-bold mb-0 text-success">{stats?.totalUsuarios ?? municipio.totalUsuarios}</h3>
                                </div>
                        ...
                        <div className="card-body">
                            <div className="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <h3 className="h2 fw-bold mb-0 text-warning">{stats?.totalEscolas ?? municipioEscolas.length}</h3>
                                </div>
